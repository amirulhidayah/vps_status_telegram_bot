...
<p align="center">
  ...
  <img src="https://img.shields.io/github/issues-raw/amirulhidayah/vps_status_telegram_bot?style=flat-square" />
</p>
...
```bash
bash <(curl -sSL https://raw.githubusercontent.com/amirulhidayah/vps_status_telegram_bot/main/vps-monitor-installer.sh) \
    --token="1234567890:AAExxxxxxxxxxxxxxxxxxxx" \
    --chat="987654321" \
    --url="https://domainanda.com"
```
...
<p align="center">
  <b>Dibuat dengan ❤️ untuk para VPS enthusiast</b>
  <br/>
  <sub>Ringan, sederhana, dan ngak pake ribet.</sub>
</p>
